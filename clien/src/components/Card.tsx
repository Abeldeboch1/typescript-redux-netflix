...
// type CardProps = {
//   movieData?: {
//     [x: string]: any; name: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | React.ReactFragment | React.ReactPortal | null | undefined;  string: any
// };
//   isLiked?: boolean; 
//   image?: number;
//   currentUser?: string;
...
//   name?: string;
// }
// export default React.memo(function Card({ movieData, name, image, isLiked = false }: CardProps) {
//   const navigate = useNavigate();
//   const dispatch = useDispatch();
//   const [isHovered, setIsHovered] = useState(false);
//   const [email, setEmail] = useState('');
